import type { Identity, Iteration, WorkItemType, WorkItemTypeState } from "@shared/types";
...
export function FilterBar({ users, iterations, statesByType }: FilterBarProps) {
  return (
    <div className="border-b border-alpha/5 bg-gray-50 px-6 py-3">
      <div className="flex items-center gap-4">
        ...
        <TypeFilterButtons />
        <StateFilterButtons statesByType={statesByType} />
