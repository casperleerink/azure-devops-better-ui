...
import type { BlogCTA } from "~/lib/sanity/sanity.types";
...
const ctaTitleStyles = cva("text-fluid-grid-xs lg:text-fluid-grid-sm font-semibold");
...
export const BlogCTAComponent = ({ value: { title, showLogo, url, type } }: { value: BlogCTA }) => {
  if (type === "contact")
    return (
