...
const formItemVariants = cva(
  "group flex flex-col gap-1 p-1.5 border rounded-lg focus-within:border-blue-500/70 focus-within:ring-4 focus-within:ring-blue-500/10 transition-colors",
  {
    variants: {
      variant: {
        default:
          "border-alpha/10 hover:border-alpha/20 hover:focus-within:border-blue-500/70 bg-gray-50",
        disabled: "border-alpha/5 bg-alpha/10",
        error: "border-red-500/70 bg-gray-50",
      },
    },
    defaultVariants: {
      variant: "default",
